from C4CApplication.views.user import *
from C4CApplication.views.non_member import *
from C4CApplication.views.member import *
...
from C4CApplication.views.system_email import *