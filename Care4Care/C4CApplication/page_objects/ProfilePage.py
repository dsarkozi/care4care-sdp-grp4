...
class ProfilePage(FixedPage):
    ...
    def __init__(self, driver):
        ...
        self.number_input       = self.driver.find_element_by_name('number')
        ...
        self.delete_account_button = buttons[len(buttons)-1]
        
    def fill_in_info(self, number, street, zip, town, phone, mobile, clear=True):
        if clear : 
